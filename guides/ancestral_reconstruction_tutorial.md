...
*   **Why is deep ASR so uncertain?**
    ...
    3.  **The "Cloud of Unknowing":** The very nature of viral evolution, with its high mutation rates and vast, often-unsampled reservoirs, means that the concept of a single, identifiable ancestral genotype can be a statistical and biological near-impossibility. Friedman (2026) explores this "cloud of unknowing" surrounding ancient viral ancestors, arguing for a shift from seeking definitive ancestors to understanding the probabilistic nature of viral emergence.
...
*   **On the Challenge of Viral Origin Reconstruction:**
    *   Friedman, R. (2026). "Scientific belief in determining the origins of viruses." Microbes & Immunity. [https://doi.org/10.36922/MI025500130](https://doi.org/10.36922/MI025500130)
