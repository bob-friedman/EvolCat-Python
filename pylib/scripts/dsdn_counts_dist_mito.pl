...
#codon_number to aa
@aa_array = qw/F F L L L L L L I I M M V V V V S S S S P P P P T T T T A A A A Y Y Z Z H H Q Q N N K K D D E E C C W W R R R R S S Z Z G G G G/;
...
sub syn_site {
	...
	$codon_syn_sites[8]=$T*3;
	$codon_syn_sites[9]=$T*3;
	$codon_syn_sites[10]=$T*3;
	$codon_syn_sites[11]=$T*3;
	...
	$codon_syn_sites[48]=$T*3;
	$codon_syn_sites[49]=$T*3;
	$codon_syn_sites[50]=$T*3;
	$codon_syn_sites[51]=$T*3;
	$codon_syn_sites[52]=3;
	$codon_syn_sites[53]=3;
	$codon_syn_sites[54]=3;
	$codon_syn_sites[55]=3;
	$codon_syn_sites[56]=3;
	$codon_syn_sites[57]=3;
	$codon_syn_sites[58]=0;
	$codon_syn_sites[59]=0;
