...
class TestNoGaps(unittest.TestCase):
    ...
    def _run_main_with_mocked_parse(self, fasta_file_arg, parse_fasta_return_value=None, parse_fasta_side_effect=None):
        ...
        with patch.object(sys, 'argv', full_argv), \
             patch('pylib.utils.seq_parser.parse_fasta_file', 
                   ...
                   side_effect=parse_fasta_side_effect) as mock_parse, \
             patch('Bio.SeqIO.write') as mock_seqio_write, \
    ...
    def test_input_file_not_found(self):
        ...
        results = self._run_main_with_mocked_parse("non_existent.fasta", parse_fasta_side_effect=FileNotFoundError)
    ...
    def test_empty_input_file_no_sequences(self):
        ...
        results = self._run_main_with_mocked_parse("empty.fasta", parse_fasta_return_value=[])
    ...
    def test_sequences_of_varying_lengths_error(self):
        ...
        results = self._run_main_with_mocked_parse("varied.fasta", parse_fasta_return_value=mock_records)
        self.assertIn("Error: Sequences in 'varied.fasta' are not of equal length.", results["stderr"])
        results["mock_exit"].assert_called_once_with(1)
    ...
    def test_valid_aligned_sequences_equal_length(self):
        ...
        mock_records = [
            MockSeqRecord("ACGT", "seq1"),
            MockSeqRecord("GATT", "seq2")
        ]
        results = self._run_main_with_mocked_parse("aligned.fasta", parse_fasta_return_value=mock_records)
    ...
    def test_sequences_of_zero_length(self):
        ...
        results = self._run_main_with_mocked_parse("zero_len.fasta", parse_fasta_return_value=mock_records)
    ...
    def test_no_invalid_columns(self):
        ...
        results = self._run_main_with_mocked_parse("no_gaps.fasta", parse_fasta_return_value=mock_records)
    ...
    def test_all_columns_are_invalid(self):
        ...
        results = self._run_main_with_mocked_parse("all_gaps.fasta", parse_fasta_return_value=mock_records)
        written_records = list(results["mock_seqio_write"].call_args[0][0])
    ...
    def test_invalid_columns_at_start_middle_end(self):
        ...
        results = self._run_main_with_mocked_parse("mixed_gaps.fasta", parse_fasta_return_value=mock_records)
        written_records = list(results["mock_seqio_write"].call_args[0][0])
    ...
    def test_mix_of_different_invalid_chars(self):
        ...
        results = self._run_main_with_mocked_parse("various_invalids.fasta", parse_fasta_return_value=mock_records)
        written_records = list(results["mock_seqio_write"].call_args[0][0])
    ...
    def test_numeric_chars_are_invalid(self):
        ...
        results = self._run_main_with_mocked_parse("numeric_gaps.fasta", parse_fasta_return_value=mock_records)
        written_records = list(results["mock_seqio_write"].call_args[0][0])
    ...
    def test_output_is_fasta_format_and_preserves_ids_desc(self):
        ...
        results = self._run_main_with_mocked_parse("output_test.fasta", parse_fasta_return_value=mock_records)
    ...
    def test_output_empty_if_all_columns_gapped_or_no_valid_input_seqs(self):
        ...
        results_all_gaps = self._run_main_with_mocked_parse("all_gaps_output.fasta", parse_fasta_return_value=mock_records_all_gaps)
        written_records_all_gaps = list(results_all_gaps["mock_seqio_write"].call_args[0][0])
        ...
        results_no_seqs = self._run_main_with_mocked_parse("no_seqs_output.fasta", parse_fasta_return_value=[])
